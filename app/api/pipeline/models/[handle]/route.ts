...
export async function PATCH(
  ...
  try {
    ...
    const allowed = ['active', 'videos_per_cycle', 'flash_frame_enabled', 'notes_for_ai', 'branding_file_text', 'pinned_character_sheet_key', 'character_sheet_r2_key', 'character_sheet_generated_at']
